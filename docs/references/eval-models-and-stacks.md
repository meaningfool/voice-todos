...
- Item 9 now covers the Voxtral realtime semantics spike
- Item 10 covers the dedicated STT benchmark track with WER, latency, and provider capability reporting
...
- `docs/superpowers/specs/2026-04-13-item9-voxtral-realtime-spike-design.md`
- `docs/superpowers/specs/2026-04-10-item10-stt-benchmark-evals-design.md`
- `docs/superpowers/plans/2026-04-10-item10-stt-benchmark-evals.md`
